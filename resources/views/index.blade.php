 ...
 <body> 
    ...
    <nav id="tf-menu" class="navbar navbar-default"> 
     <div class="container"> 
      ...
      <div class="navbar-header"> 
       ...
       <a class="navbar-brand logo" href="/">Awesomeness</a> 
      </div> 
  ...
  <div id="tf-portfolio"> 
   <div class="container"> 
    ...
    <div class="row"> 
     <div class="col-md-4"> 
      <img class="img-responsive" src="../image/09.jpg"> 
     </div> 
     <div class="col-md-4"> 
      <img class="img-responsive" src="../image/02.jpg"> 
     </div> 
     <div class="col-md-4"> 
      <img class="img-responsive" src="../image/03.jpg"> 
     </div> 
    </div> 
    <div class="row toppadding"> 
     <div class="col-md-4"> 
      <img class="img-responsive" src="../image/04.jpg"> 
     </div> 
     <div class="col-md-4"> 
      <img class="img-responsive" src="../image/05.jpg"> 
     </div> 
     <div class="col-md-4"> 
      <img class="img-responsive" src="../image/06.jpg"> 
     </div> 
    </div> 
   </div> 
  </div> 
     ...
     <div class="row"> 
      <div class="col-md-6"> 
       ...
       <ul class="list-inline why-me"> 
        <li> <h4>I Do Brand that Sells</h4> <p>Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.</p> </li> 
        <li> <h4>You will love my Designs</h4> <p>Donec lacinia congue felis in faucibus. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.</p> </li> 
        <li> <h4>I Deliver on Time</h4> <p>Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.</p> </li> 
       </ul> 
